...
import (
	...
	"github.com/Idiotmann/orderfile/domain/repository"
	service2 "github.com/Idiotmann/orderfile/domain/service"
	"github.com/Idiotmann/orderfile/handler"
	orderPb "github.com/Idiotmann/orderfile/proto"
...
func main() {
	...
	// Register Handler
	orderPb.RegisterOrderHandler(service.Server(), &handler.Order{OrderDataService: orderDataService})
